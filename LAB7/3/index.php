...
<body>
        ...
        <div class="m-5 text-white p-4 box">
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER[" PHP_SELF"]); ?>">
                <div class="form-group mb-3 <?php echo $idErr ?>">
                    ...
                    <input type="text" name="id" class="form-control" id="inputid" max="13" placeholder="x xxxx xxxxx xx x">
                </div>
                <div class="row">
                ...
                <div class="form-group mb-3 <?php echo $tumErr ?>">
                    ...
                    <input type="text" name="tum" class="form-control" id="inputAddress2" placeholder="">
                </div>
                <div class="row">
                    <div class="form-group col-md-6 mb-3 <?php echo $aumErr ?>">
                        <label for="inputCity">อำเถอ</label>
                        <input type="text" name="aum" class="form-control" id="inputCity">
                    </div>
                ...
                <div class="form-group mb-3 <?php echo $phoneErr ?>">
                    ...
                    <input type="text" name="phone" class="form-control" id="inputid" max="13" min="13" placeholder="Phone Number">
                </div>
    ...
    echo $nameErr . $lnameErr . $addressErr . $tumErr . $idErr . $aumErr . $provinceErr . $zipErr . $phoneErr
